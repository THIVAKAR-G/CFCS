          ...
          <div class="tab-pane" id="settings">
            <form role="form" id=""  method="post" enctype="multipart/form-data" >
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  <label for="inputName2" class="col-sm-2 col-md-6 col-form-label">Location</label>
                  <div class="col-sm-10">
                    <input type="url" class="form-control" name="village" id="village" value="<?php  echo $row['village'];?>">
                  </div>
                </div>
              </div>
