                  ...
                  <form role="form" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                          <label for="age">Department<span style="color: blue;">*optional</span></label>
                      ...
                      <textarea class="form-control" id="address" name="address" rows="3" placeholder="Enter your residential address" required></textarea>
                       </div>
                        <div class="form-group col-md-2">
                      ...
                      <textarea class="form-control" id="address" name="address" rows="3" placeholder="Enter your residential address" required></textarea>
                       ...
                       <div class="form-group col-md-3">
                          ...
                          <input type="url" class="form-control" id="village" name="village" placeholder="Map url"required>
                          </div>
                        <div class="form-group col-md-3 ">
